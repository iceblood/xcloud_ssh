...
sedcmd=${SEDCMD:-sed}
defaultprivoxydir="/opt/app/sshtunnel/etc/config"
defaulturls=("https://raw.githubusercontent.com/knight00931/chinalist/master/chinalist-lite.txt")
...
function doconvert() {
  ...
  do
    ...
    ./wget-ssl -t 3 --no-check-certificate -O ${file} "${url}" >${tempdir}/wget-${url//\//#}.log 2>&1
